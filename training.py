...
mlp = MLPRegressor(solver='adam', hidden_layer_sizes=(500, 200, 200), max_iter=500, early_stopping=False, beta_1=0.9,
                   random_state=0, validation_fraction=0, verbose=True, activation='identity', alpha=0.0001)
...
ax1.scatter(range(x_mat_test.shape[0]), y_predicted_test, s=10, c='r', marker="o", label='predicted')
ax1.legend()
